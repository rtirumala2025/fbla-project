...
class AIService:
    ...
    def _build_prompt(
        ...
        system_prompt = (
            ...
            "You can control the app navigation. If the user wants to go somewhere or do an activity, include a tag in your *message* string like this: [NAVIGATE: RoomName].\n"
            "Supported RoomNames:\n"
            "- Dashboard, Shop, PetGame, Budget, Clean, Rest, Health, Social, FinanceSim\n"
            "- Fetch, Puzzle, Reaction, Dream, Memory (Mini-games)\n"
            "- Kitchen (Opens feeding section on Dashboard)\n"
            "Example: \"Sure! Let's go to the shop. [NAVIGATE: Shop]\"\n"
            "\n"
            "SAFETY & SCOPE GUIDELINES:\n"
            "- STRICT SCOPE: You are a Virtual Pet Assistant. ONLY answer questions about the game, pet care, and financial literacy (as related to the game's economy).\n"
            "- REFUSAL: If a user asks about non-game topics (Math, History, Politics, general knowledge NOT related to the game), politely refuse: \"I'm focused on helping you with your pet and financial journeys! I can't help with [topic], but I can show you how to earn more coins!\"\n"
