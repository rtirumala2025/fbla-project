...
export async function getPetAIInsights({ token }: AuthenticatedRequestOptions): Promise<PetAIInsights> {
  try {
...
export async function getPetAINotifications({ token }: AuthenticatedRequestOptions): Promise<PetNotification[]> {
  try {
...
export async function getPetAIHelp({ token }: AuthenticatedRequestOptions): Promise<PetHelpResponse> {
  try {
...
export async function parsePetAICommand(
  payload: { command_text: string },
  { token }: AuthenticatedRequestOptions,
): Promise<PetCommandResponse> {
  try {
