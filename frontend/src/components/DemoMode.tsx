/**
 * DemoMode Component
 * Displays demo mode interface when Supabase is not configured
 */
type DemoModeProps = {
        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm text-slate-600">
              Re-run with valid <code className="rounded bg-slate-100 px-1">REACT_APP_SUPABASE_URL</code> and{' '}
              <code className="rounded bg-slate-100 px-1">REACT_APP_SUPABASE_ANON_KEY</code> to reconnect Supabase.
            </p>
          </article>
        </section>
      </main>
