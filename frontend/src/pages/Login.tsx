...
export const Login = () => {
  ...
  // Validate Supabase OAuth configuration on mount
  useEffect(() => {
    const runValidation = async () => {
      console.log('\n🔍 Running OAuth Configuration Validation...\n');
      const result = await validateSupabaseOAuth();
      
      if (!result.isValid) {
        console.log('\n📋 Setup Checklist:');
        console.log(generateSetupChecklist());
      }
    };
    
    // Run validation after a short delay to avoid blocking render
